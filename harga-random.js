...
s1[0] = "<br> Wiremesh M4 harga = ";
s1[1] = "<br> Wiremesh M5 harga = ";
s1[2] = "<br> Wiremesh M6 harga = ";
s1[3] = "<br> Wiremesh M7 harga = ";
s1[4] = "<br> Wiremesh M8 harga = ";
s1[5] = "<br> Wiremesh M9 harga = ";
s1[6] = "<br> Wiremesh M10 harga = ";
var s2 = new Array ();
s2[0] = "Rp "+m4;
s2[1] = "Rp "+m5;
s2[2] = "Rp "+m6;
...
var s1 = new Array ();
s1[0] = "<br> Besi Beton &#8960; 6 harga = ";
s1[1] = "<br> Besi Beton &#8960; 8 harga = ";
s1[2] = "<br> Besi Beton &#8960; 10 harga = ";
s1[3] = "<br> Besi Beton &#8960; 12 harga = ";
s1[4] = "<br> Besi Beton &#8960; 16 harga = ";
s1[5] = "<br> Besi Beton &#8960; 19 harga = ";
s1[6] = "<br> Besi Beton &#8960; 25 harga = ";
s1[7] = "<br> Besi Beton D 10 harga = ";
s1[8] = "<br> Besi Beton D 13 harga = ";
s1[9] = "<br> Besi Beton D 16 harga = ";
s1[10] = "<br> Besi Beton D 19 harga = ";
s1[11] = "<br> Besi Beton D 22 harga = ";
s1[12] = "<br> Besi Beton D 25 harga = ";
s1[13] = "<br> Besi Beton D 32 harga = ";
var s2 = new Array ();
s2[0] = "Rp "+b6;
s2[1] = "Rp "+b8;
s2[2] = "Rp "+b10;
