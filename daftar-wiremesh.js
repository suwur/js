...
document.getElementById("suhw").insertAdjacentHTML("afterend","<br>(daftar ini hanya sebagai acuan, permintaan penawaran untuk kebutuhan dan lokasi anda, silakan langsung ke admin)");
}
