...
harga = hbes * berat;
document.getElementById("result").innerHTML = "<span id = 'res'> Berat (per batang) :  </span>" + berat + "<span id = 'res'> kg <br>HARGA : Rp "+hbes.toFixed(3)+" per kg<br> = Rp </span>"+harga.toFixed(3)+"<span id = 'res'> per lembar</span>";
if (se < 1){
